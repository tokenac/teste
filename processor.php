...
if (isset($_GET['token']) && isset($_GET['PayerID']) ){
        ...
        if($json_resp['state']=='approved'){
            ...
            if($is_upgrade==1){
                ...
                wpestate_insert_invoice('Upgrade to Featured','One Time',$listing_id,$date,$current_user->ID,0,1,'' );
                ...
                if($is_featured==1){
                    update_post_meta($listing_id, 'prop_featured', 1);
                    wpestate_insert_invoice('Publish Listing with Featured','One Time',$listing_id,$date,$current_user->ID,1,0,'' );
                }else{
                    wpestate_insert_invoice('Listing','One Time',$listing_id,$date,$current_user->ID,0,0,'' );
                }
